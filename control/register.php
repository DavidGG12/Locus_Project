<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        if(isset($_POST['register_user']))
        {
            ...
            registerUser(null, $email_register, $password, $password_repeat, $user_register, 2, null);
        }
        elseif(isset($_POST['register_colaborator']))
        {
            ...
            registerUser(null, $email_register_colaborator, $password_colaborator, $password_repeat_colaborator, $user_register_colaborator, 3, null);
        }
    }
