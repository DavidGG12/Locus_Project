        ...
        $('#search').keyup(function() {
          ...
          $.ajax({
            ...
            success: function(response) {
              ...
              // Ocultar el elemento cuando se realiza la búsqueda
      ...
      <ul class="navbar-nav ms-auto" >
        ...
        <li class="nav-item">
          <?php if(!isset($_COOKIE['user'])): ?>
            <a class="nav-link" style="font-family: 'Oswald', sans-serif; font-size: 20px;" href="http://locuslist.cleverapps.io/login.php">Iniciar sesión</a>
...
<!----Nav Opciones-->
  <div class="container bg-light-subtle m-3">
    <div class="row m-1">
      <div class="col-md-4">
        <nav class="nav">
          <a class="nav-link" href="plataforma.php?platform=NINTENDO">NINTENDO</a>
          <a class="nav-link" href="plataforma.php?platform=PLAYSTATION">PLAYSTATION</a>
          <a class="nav-link" href="plataforma.php?platform=XBOX">XBOX</a>
