...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/LOCUS/estilos/lista.css">

</head>
<body style="background-color: #eef2f4;">
      <!--barra de navegación-->
	...
	<div class="banner">
		<img src="http://localhost/Locus_Project/imagenes/locus_l1.png" alt="">
    </div>
	  ...
	  <div class="container btn-click-container">
		<div class="row">
			<ul class="nav nav-tabs">
				<li class="nav-item">
				  <a class="nav-link" style="font-family: 'Geologica', sans-serif;" onclick="mostrarFormulario('juegos')">Todos</a>
				</li>
				<li class="nav-item">
                  ...
                  // Comprobar la conexión
                    ...
                    $query = "SELECT TITLE, SUBTITLE, DESCRIPTION_GAME, PFNAME FROM list_games
                      ...
                      INNER JOIN platform on videogames.PLATFORM_GAMES = platform.ID_PLATFORM
                        WHERE USER_LIST = ". $row_id['ID_USER'];
